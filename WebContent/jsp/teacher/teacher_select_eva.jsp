...
<link rel="stylesheet" type="text/css"
	href="css/teacher_select_eva.css" />
</head>
<body>
<div id="div1">
  <div id="top">
  ...
  <div id="tablefoot">
    <ul>
      <li id="btn2">
        <div class="page_up" is="">上一页</div>
      </li>
      <li id="btn1">
        <div class="page_up" is="">下一页</div>
      </li>
      <li sumpage="">共225页</li>
      <li>共225条记录</li>
      <li>到第
        <input type="text" class="bage" />
        页 </li>
      <li><div class="queding" is="">确定</div></li>
    </ul>
  </div>
</div>
<script type="text/javascript" src="js/teacher_select_eva.js"></script>
</body>
</html>