...
<div id="gold1">
  <div class="left">
    <ul>
      ...
      <li><span class="sp">姓名</span>
        <input type="text" name="name" class=" text1" id="c2" onchange="nullyz($(this))" is="false"/>
      </li>
      ...
      <li><span class="sp">性别</span>
        <div class="div_text">
          <input type="radio" name="sex" value="boy" is="true"/>
          男
      ...
      <li><span class="sp">类别</span>
        <select name="category" class=" text1" autocomplete="off">
      ...
      <li><span class="sp">学历</span>
        <select name="education_bg" class=" text1" autocomplete="off">
  ...
  <div class="bottom">修改信息</div>
</div>
<script src="js/teacher_showEditStudentInfo.js"></script>
</body>
</html>