...
<link rel="stylesheet" type="text/css"
	href="css/teacher_select_schoolmessage.css" />
</head>
<body>
	<div id="div1">
		<div id="top">
			<div id="top1_1">
				<div class="top1_2">院校名称</div>
				<div class="top1_3">
					<input type="text" id="classes" name="" class="lay1" />
				</div>
				<div class="top1_2">学院名称</div>
				<div class="top1_3">
	...
	<script type="text/javascript" src="js/teacher_select_schoolmessage.js"></script>
</body>
</html>