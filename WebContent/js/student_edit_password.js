$(document).ready(function(){
	"use strict";
	var UandP=$("#changepw_student>.changepw>.changepw_con input");
	var confirm=$("#changepw_student>.changepw>.changepw_con>.changepwin");
	var back=$("#changepwin_student>.changepwin>.changepwin_con>.reg");
			...
			if (newPassword.val() === "") {
				...
				if (confirmPassword.val() === "") {
					...
					if (newPassword.val()!=confirmPassword.val()) {
						...
						$.ajax({
							url : 'student_updatePassword.action',
							type : 'POST',
							data : {
